    ...
    try {
        ...
        browser = await puppeteer.launch({
            ...
            args: [
                ...
                '--disable-gpu',  // Desactiva la GPU para evitar ventanas gráficas
                '--disable-dev-shm-usage',
                '--window-size=1,1',  // Cambia el tamaño de la ventana
                '--remote-debugging-port=9222',  // No debería abrir ninguna ventana de navegador
            ]
        });
